...
import { archiveArticleAction } from '@/actions/articles';
      ...
      >
        <div className="space-y-4 font-mono text-xs">
          <p className="text-terminal-text-secondary">
            Are you sure you want to archive <strong className="text-terminal-text-primary">"{articleTitle}"</strong>?
          </p>
          <p className="text-[11px] text-terminal-text-muted">
            The article will be soft-archived and removed from public listings immediately.
          </p>
...
export const DeleteArticleButton = ArchiveArticleButton;
