      ...
      >
        <div className="space-y-4 font-mono text-xs">
          <p className="text-terminal-text-secondary">
            Are you sure you want to delete <strong className="text-terminal-text-primary">"{certificateName}"</strong>?
          </p>
          <p className="text-[11px] text-terminal-text-muted">
            The credential will be soft-deleted and removed from the public showcase immediately.
          </p>
